...
import 'package:my_carpool/newjob.dart';
import 'package:geolocator/geolocator.dart';
import 'package:flutter/services.dart';
import 'package:my_carpool/registrationscreen.dart';
import 'package:my_carpool/user.dart';
...
class _TabScreen2State extends State<TabScreen2> {
  ...
  Future<String> makeRequest() async {
    String urlLoadJobs = "http://mobilehost2019.com/MyPlumber2/php/load_job_user.php";
  ...
  Future<String> deleteRequest(String jobid) async {
    String urlLoadJobs = "http://mobilehost2019.com/MyPlumber2/php/delete_job.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
